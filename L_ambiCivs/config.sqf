...
L_ambiCivs_minSpawnDistance 		= 50;		// Minimum distance to players when spawning civilians
L_ambiCivs_maxDistanceToPlayers    	= 150;		// Maximum distance to players, both for spawning and deleting civilians

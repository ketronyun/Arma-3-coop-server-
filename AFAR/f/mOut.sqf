...
[(r_ptt#0),currentChannel,[r_p]]call r_out2;{(_x#0)enableChannel[false,false];(_x#1)radioChannelRemove[r_p]}forEach[[(ch6+5),ch6],[(ch7+5),ch7],[(ch8+5),ch8]];setCurrentChannel 5;{r_p remoteExecCall["r_out",_x]}forEach _p}else{

...
private _seat=((assignedVehicleRole r_p in[["driver"],["Driver"],["Turret",[0]],["Turret",[0,0]]])&&{(objectParent r_p isKindOf"Air"&&!(objectParent r_p isKindOf"ParachuteBase"))});
private _ch6=(ch6+5);private _ch7=(ch7+5);private _ch8=(ch8+5);
private _RTO=r_RTOBP findIf{unitBackpack r_p isKindOf _x}>=0;
playSound"r_nob";
switch(true)do{
...
case(_CH in[_ch6,_ch7,_ch8]):{setCurrentChannel 5}
};
private _CH=currentChannel;
private _txt=[switch(_CH)do{
case 1:{"SIDE"};
case 2:{"COMMAND"};
case 3:{"GROUP"};
case 4:{"VEHICLE"};

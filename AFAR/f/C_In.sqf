...
private _p=(allPlayers-[r_p]select{leader group _x==_x&&side _x==playerSide});
if(r_alertOn)then{r_p call r_alert};
if(count _p>0)then{
if((r_incap)&&(lifeState r_p=="INCAPACITATED"))then{playSound"inB2";[(r_ptt#0),2,_p]call r_out2;setCurrentChannel 5}else{
